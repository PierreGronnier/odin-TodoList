...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const defaultProjectExists = AppLogic.projects.some(
    (project) => project.title === defaultProjectTitle,
  );

  if (!defaultProjectExists) {
    const defaultProject = AppLogic.addProject(
      new Project(defaultProjectTitle, "Default description"),
    );
